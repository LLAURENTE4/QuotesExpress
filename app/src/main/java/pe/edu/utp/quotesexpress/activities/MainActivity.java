...
import pe.edu.utp.quotesexpress.adapters.QuotesAdapter;
...
// 2 no esta inicializado
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // subclases de RecyclerView ****adapter *** viewHolder **
        quotesRecyclerView.setAdapter(new QuotesAdapter(service.getQuotes())); // optiene la lista de elementos
